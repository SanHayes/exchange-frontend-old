  ...
  <div id="AffiliatePage">
    <div v-if="!isVip" class="bodyContent affiliatePage">
          ...
          <div class="container h-full">
            <div class="vx-row h-full items-center">
              <div class="vx-col lg:w-6/12">
                <p class="text-4xl font-bold white line-height-normal mb-4">
                  Bạn cần trở thành Thành viên VIP để nhận hoa hồng VIP và hoa
                  hồng giao dịch
                </p>
                <vs-button
                  size="large"
                ...
                <div class="affiliateInfo bgSecondary borderPrimary">
                  <div class="linkGroup">
                    <div class="vx-col flex-col justify-center">
                      <div class="w-full">
                        <p class="color-gray colorSecondary mb-2 label">
                          Link Đăng ký
                        </p>
                        <div class="groupButton flex mb-4 relative">
                          <div class="leftControl">
                            <input
                              ...
                              readonly="readonly"
                              disabled
                              class="form-control w-full text-base pl-2"
                            />
                          </div>
                          <div class="rightControl">
                            <button
                              class="btn button primary cursor-pointer"
                              v-clipboard:copy="linkDk"
                              @click="saoChep"
                            >
                              Sao chép
                            </button>
                      ...
                      <div class="w-6/12">
                        <p class="color-light-gray mb-2 colorSecondary label">
                          Mã giới thiệu
                        </p>
                        <div class="groupButton flex mb-4 relative">
                          <div class="leftControl">
                          ...
                          <div class="rightControl">
                            <button
                              class="btn button primary cursor-pointer"
                              v-clipboard:copy="codeGioiThieu"
                              @click="saoChep"
                            >
                              Sao chép
                            </button>
                ...
                <div class="flex items-center">
                  ...
                  <div>
                    <div class="textContent">
                      ...
                      <p class="color-white-50 mb-0 des">
                        Mời bạn bè đăng ký {{ domain }} qua liên kết
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div class="flex items-center">
                  ...
                  <div>
                    <div class="textContent">
                      ...
                      <p class="color-white-50 mb-0 des">
                        Bạn của bạn đồng ý lời mới, hoàn tất đăng ký và giao
                        dịch
                      </p>
                    </div>
                  </div>
      ...
      <vs-popup
        class="text-center"
        title="Trở thành VIP"
        :active.sync="popupBuyThamGiaVip"
      >
        <div class="contentWrapper" :class="{ 'ld-loading': loading }">
          ...
          <div class="header borderBtSecondary">
            <span class="text-2xl font-bold capitalize modal-title"
              >Chấp nhận tham gia</span
            >
          </div>
          <div class="body">
            <div class="imgShake mb-3"></div>
            <div class="textContent mb-3 colorSecondary">
      ...
      <vs-popup
        class="text-center"
        title="Thông Báo"
        :active.sync="popupThongBao"
      >
        <div class="contentWrapper">
          <div class="header borderBtSecondary">
            <span class="text-2xl font-bold capitalize modal-title"
              >Số dư của bạn không đủ</span
            >
          </div>
          <div class="body">
            <img
              :src="require('@/assets/images/sky/not_enought_balance.svg')"
              alt=""
            />
        ...
        <div class="m-6">
                ...
                <div class="vx-row">
                      ...
                      >
                        <div class="flex boxRank items-center">
                          <div class="rank-number">
                            <div
                              class="backgroundImd iconRank"
                              :class="`rank${vip_lv}`"
                            ></div>
                          </div>
                          <div class="rank-text">
                            <p
                              class="textRank noselect cursor-pointer bgPrimary"
                            >
                      ...
                      <div class="body">
                        ...
                        <div class="vx-row">
                          <div class="vx-col w-2/3">
                            <p class="text-base white-50 mb-2 name">
                              F1 tổng (Tuần này)
                            </p>
                            <p
                              class="
                            ...
                            >
                              ...
                              <span class="colorGray" v-if="vip_lv == 1"
                                >2,000</span
                              >
                              <span class="colorGray" v-if="vip_lv == 2"
                                >4,000</span
                              >
                              <span class="colorGray" v-if="vip_lv == 3"
                                >8,000</span
                              >
                              <span class="colorGray" v-if="vip_lv == 4"
                                >16,000</span
                              >
                              <span class="colorGray" v-if="vip_lv == 5"
                                >32,000</span
                              >
                              <span class="colorGray" v-if="vip_lv == 6"
                                >64,000</span
                              >
                              <span class="colorGray" v-if="vip_lv >= 7"
                                >128,000</span
                              >
                            </p>
                          </div>
                  ...
                  <div class="vx-col w-full lg:w-1/3 mb-4">
                    <div class="affiliateInfo bgSecondary borderSecondary">
                      <div class="referralSponsor">
                        <p class="mb-0">
                          <span class="text-xs colorSecondary mb-2"
                            >Người giới thiệu</span
                          >
                        </p>
                        <p>
                          <span class="text-2xl colorSecondary mb-2 value">{{
                            f1cuaminh != "" ? f1cuaminh : "-----"
                          }}</span>
                        </p>
                      </div>
                      ...
                      <div class="linkGroup m-0">
                        <div class="vx-row">
                          <div class="vx-col w-1/2 mb-2">
                            <p class="text-xs colorSecondary2 mb-2">
                              Tổng số nhà giao dịch
                            </p>
                            <p class="totalReferral colorSuccess text-2xl">
                              {{ totalNGD }}
                            </p>
                          </div>
                          <div class="vx-col w-1/2 mb-2">
                            ...
                            <p class="totalAgency colorPrimary text-2xl">
                              {{ totalDaiLy }}
                            </p>
                          </div>
                          <div class="vx-col w-1/2">
                            ...
                            <p class="colorDanger text-2xl m-0">
                              {{ commissGD.toFixed(2) }}
                            </p>
                          </div>
                          <div class="vx-col w-1/2">
                            ...
                            <p class="colorPrimary text-2xl m-0">
                              {{ pen_commiss }}
                            </p>
                          </div>
                        </div>
                  ...
                  <div class="vx-col w-full lg:w-2/3 mb-4">
                    ...
                    >
                      <vs-tabs>
                        <vs-tab
                          label="Tháng này"
                          @click="(showTN = true), (showTT = false)"
                        >
                        </vs-tab>
                        <vs-tab
                          label="Tháng trước"
                          @click="(showTT = true), (showTN = false)"
                        >
                        </vs-tab>
                      </vs-tabs>
                      <div class="p-2">
                        <div
                          class="tn"
                          :class="{ block: showTN, hidden: !showTN }"
                        >
                          <div class="content">
                            <div class="vx-row">
                              <div class="vx-col w-full lg:w-1/3">
                                ...
                                <p class="totalReferral colorSuccess mb-4">
                                  Tổng số nhà giao dịch mới ({{ tslgdmtn }})
                                </p>
                                <p class="totalAgency colorBlue mb-4">
                                  Tổng số đại lý mới ({{ tsdlmtn }})
                                </p>
                                <p class="colorDanger">
                                  Tổng số hoa hồng mới ({{
                                    tshhmtn.toFixed(3)
                                  }})
                                </p>
                              </div>
                        ...
                        <div
                          class="tt"
                          :class="{ show: showTT, hidden: !showTT }"
                        >
                          <div class="content">
                            <div class="vx-row">
                              <div class="vx-col w-full lg:w-1/3">
                                ...
                                <p class="totalReferral colorSuccess mb-4">
                                  Tổng số nhà giao dịch mới ({{ tslgdmtt }})
                                </p>
                                <p class="totalAgency colorBlue mb-4">
                                  Tổng số đại lý mới ({{ tsdlmtt }})
                                </p>
                                <p class="colorDanger">
                                  Tổng số hoa hồng mới ({{ tshhmtt }})
                                </p>
                              </div>
                              <div class="vx-col w-full lg:w-2/3">
                                <div class="wrap-chart bgPrimary">
                  ...
                  <div class="vx-col w-full lg:w-1/3 mb-4">
                    <div class="networkVolumeStats bgSecondary borderSecondary">
                      <div class="cardHeader flex items-center">
                        ...
                        <vs-dropdown vs-custom-content vs-trigger-click>
                          ...
                          <vs-dropdown-menu class="dropdown-question">
                            <p class="m-0 text-sm">
                              Tổng khối lượng giao dịch của 8 tầng mỗi tháng.
                            </p>
                          </vs-dropdown-menu>
                        </vs-dropdown>
                      </div>
                      <div class="cardBody">
                        <div
                          class="vx-row head border-bottom border-top"
                          style="width: 360px"
                        >
                  ...
                  <div class="vx-col w-full lg:w-1/3 mb-4">
                    <div class="getIntouch bgSecondary borderSecondary">
                      <div class="cardHeader flex items-center">
                        ...
                        ><span class="text-xl white font-bold getIntouch-title"
                          >Liên hệ</span
                        >
                      </div>
                      <div class="cardBody">
                        <div class="vx-row">
                          <div class="vx-col lg:w-4/12 text-center">
                            <img
                              :src="require('@/assets/images/sky/bot.svg')"
                              alt=""
                              class="mb-3"
                            />
                            <p
                          ...
                          <div class="vx-col lg:w-8/12">
                            <p class="white-50 text-base mb-2 getIntouch-label">
                              Địa chỉ Email
                            </p>
                            <p class="flex items-center">
                              <feather-icon
                                icon="MailIcon"
                                svgClasses="h-6 w-6 ml-1 c-mail"
                              />
                              <a
            ...
            <div class="wraperContent">
              ...
              >
                ...
                <div class="affCommissionControl items-end flex flex-wrap">
                  <div class="blockLine flex flex-col mr-3">
                    ...
                    <v-select
                      class="w-64 relative"
                      v-model="selectedHoaHong"
                      :options="optionsHoaHong"
                      :dir="$vs.rtl ? 'rtl' : 'ltr'"
                    />
                  </div>
                  ...
                  <vs-button
                    ...
                    type="filled"
                    @click="clickSearchDateTimeHoaHong"
                    >Tìm kiếm</vs-button
                  >
                </div>
              </div>
              <div class="notice-comission mb-4">
                <p>
                  ...
                  <span style="color: #8d97a0"
                    >Bạn sẽ nhận hoa hồng giao dịch từ tuyến dưới của ngay lập
                    tức.</span
                  >
                </p>
              </div>
              <div class="body vx-row">
                <!-- <div class="vx-col w-full lg:w-4/12 lg:mb-5 lg:pr-0">Mỗi ngày mới, bạn sẽ nhận hoa hồng giao dịch từ tuyến dưới của ngày hôm trước.
                                        <div class="wrap-chart bgSecondary boxShadowDashBoard commission-chart">
                                            <div class="header">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="19.135" height="16.02" viewBox="0 0 19.135 16.02"><g id="edit-curves" transform="translate(0 -2)"><path id="Path_29616" data-name="Path 29616" d="M5,13.9C14.346,13.9,9.673,3,19.02,3" transform="translate(-0.885 0)" fill="none" stroke="#E46D02" stroke-linecap="square" stroke-miterlimit="10" stroke-width="2"></path><path id="Path_29617" data-name="Path 29617" d="M18.135,17.02H1V3" transform="translate(0 0)" fill="none" stroke="#E46D02" stroke-linecap="square" stroke-miterlimit="10" stroke-width="2"></path></g></svg>
                ...
                <div class="vx-col w-full lg:mt-0 mt-4">
                  <div
                    class="tableBackground bgSecondary trading-detail relative"
                    v-if="selectedHoaHong.id == 1"
                  >
                    <table
                      class="table table-dark w-full tableComission bgSecondary"
                    ...
                    >
                      ...
                      <tbody
                        class="text-center table-content"
                        v-if="listChiTietKLGD.length == 0"
                      >
                        <tr>
                          <td colspan="5"><span>Không có dữ liệu</span></td>
                        </tr>
                      </tbody>
                      <tbody class="table-content" v-else>
                        <tr
                          :key="indextr"
                          v-for="(tr, indextr) in listChiTietKLGD"
                        >
                  ...
                  >
                    ...
                    >
                      ...
                      <tbody
                        class="text-center table-content"
                        v-if="listChiTietKLVip.length == 0"
                      >
                        <tr>
                          <td colspan="5"><span>Không có dữ liệu</span></td>
                        </tr>
                      ...
                      <tbody class="table-content" v-else>
                        <tr
                          :key="indextr"
                          v-for="(tr, indextr) in listChiTietKLVip"
                        >
                          <td class="colorSecondary">
                            {{ formatDateAff2(tr.dt) }}
                          </td>
          ...
          <div class="qlht" :class="{ block: showqlHt }">
            <div class="w-full lg:pl-0 px-0">
              <div>
                <div class="filterDiv">
                  <h1 class="text-2xl white font-bold capitalize mb-4">
                    Quản lý đại lý
                  </h1>
                  <div class="flex flex-wrap">
                    <div class="relative colFirst lg:mr-5 align-middle">
                      <p class="color-white-50 mb-1 aff-test-type">
                        Tìm kiếm bằng
                      </p>
                      <button
                        class="
                      ...
                      <button
                        class="btn search btnSearchType button cursor-pointer"
                    ...
                    <div class="md:w-1/2 align-middle">
                      <div class="lg:ml-8">
                        <div class="color-white-50 mb-1 aff-text-type">
                          Xem Người bạn giới thiệu bằng
                          {{ showActiveLv ? "Cấp bậc" : "tên" }}
                        </div>
                        <div class="flex">
                          <v-select
                            :class="{
                ...
                <div class="paddingResult">
                  <div class="mb-3 flex flex-wrap">
                    <h1 class="text-2xl white font-bold capitalize">
                      Kết quả tìm kiếm
                    </h1>
                    <div
                      class="ml-auto flex flex-wrap scrollRange items-center"
                    >
                      <span class="textTime mr-4">Khoảng thời gian:</span>
                      <button
                        class="btn btnTime mr-3 cursor-pointer"
                        :class="{ 'button primary active': oneday }"
                      ...
                      <button
                        class="btn btnTime mr-3 cursor-pointer"
                        :class="{ 'button primary active': twoday }"
                      ...
                      <button
                        class="btn btnTime cursor-pointer"
                        :class="{ 'button primary active': allday }"
                      ...
                      >
                        ...
                        <tbody v-else>
                          <tr :key="itr" v-for="(tr, itr) in datalistAgency">
                            <td>
                              <a href.prevent class="color-yellow underline">{{
                                tr.nick_name
                              }}</a>
                            </td>
                            <td>{{ tr.level_vip }}</td>
...
const chartOne = {
  ...
  xAxis: {
    categories: ["Tuần một", "Tuần hai", "Tuần ba", "Tuần bốn"],
    plotBands: [
      {
...
const chartTwo = {
  ...
  xAxis: {
    categories: ["Tuần một", "Tuần hai", "Tuần bả", "Tuần bốn"],
    plotBands: [
      {
        // visualize the weekend
        from: 4.5,
...
.tableBackground .table-dark th:after {
  ...
  left: 0;
  width: 100%;
  /* border-bottom: 1px solid #E46D02; */
}
