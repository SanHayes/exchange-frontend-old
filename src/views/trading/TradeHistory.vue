    ...
    <div class="vx-row">
          ...
          <div class="wrap-chart">
            <div class="chart-instance">
              ...
              <div class="row">
                ...
                <div class="col-md-6 py-md-3 mb-3">
                  <div class="row wrap">
                    <div class="label colorWhite mb-3 col-md-12">
                      <span
                        class="round round--win"
                        style="background-color: rgb(45, 85, 253)"
                      ></span
                      ><span>Tổng vòng thắng</span>
                    </div>
                    <div class="label colorWhite mb-3 col-md-12">
                      <span
                    ...
                    <div class="label colorWhite mb-3 col-md-12">
                      ...
                      ></span
                      ><span>Tổng vòng thua</span>
                    </div>
                  </div>
                </div>
                <div class="col-md-6 lg-py-3 borderRightColor mb-sm-3 win-rate">
                  <p class="colorWhite67 text-center m-0 mb-2 name">
                    Tỷ lệ thắng
                  </p>
                  <p class="colorWhite text-center value">
                ...
                <div class="col-md-6 total-trade">
                  ...
                  <p class="colorWhite text-center value">${{ trades }}</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="vx-col w-full lg:w-1/2 mt-2 lg:pr-0">
        <div class="vx-row">
          ...
          <div class="vx-col w-full relative my-5">
            <h4
              class="stacked-bar-chart-title text-center font-20 color-white mb-3"
            >
              Tóm tắt giao dịch
            </h4>
        ...
        >
          ...
          <tbody v-else>
            <tr :key="indextr" v-for="(tr, indextr) in dataHisOrder">
              ...
              <td class="text-center">30 giây</td>
