<template>
  <div id="main-content" class="hasSidebar">
    <div id="community-jackpot" class="community-jackpot">
      <h1 class="community-jackpot-title">Streak Challenge</h1>
      <div class="prize-pool">
        <h3 class="prize-pool-label"><span>Prize Pool</span></h3>
        <p class="prize-pool-value mb-0">
          ${{ this.nFormatter(prize.sum, 2) }}
        </p>
        <span class="prize-pool-mega-fund"
          >${{ this.nFormatter(prize.sum * prize.precent, 2) }}</span
        >
      </div>
      <a href="/trading" class="nav-link go-trade">Giao dịch và Thắng Giải</a>
      <p class="link-to-info mb-0" @click="scrollToInfo">Xem thêm thông tin</p>
      <div class="bg">
        <div class="latest-winner">
          <div class="container">
            <h3 class="latest-winner-subtitle">Danh sách người nhận giải</h3>
            <h2 class="latest-winner-title">Latest Winners</h2>
            <div class="latest-winner-mega">
              <div class="loading">
              ...
              <h4 class="latest-winner-mega-title">mega jackpot winner</h4>
              <div class="latest-winner-mega-body">
                <p class="latest-winner-mega-name">
                  {{ streakChallengeRender.user }}
                </p>
                <p class="latest-winner-mega-text">
                  Won Mega Prizes {{ streakChallengeRender.userDate }}
                </p>
              </div>
              <span class="latest-winner-mega-prize"
                >${{ streakChallengeRender.userMoney }}</span
              >
            </div>
            <!-- table -->
            <div class="latest-winner-table">
              <ul class="nav nav-tabs">
                <li
                  :class="['item', historyTab == 'all' ? 'active' : '']"
                  @click="historyTab = 'all'"
                >
                  Lịch sử nhận giải
                </li>
                <li
                  :class="['item', historyTab === 'user' ? 'active' : '']"
                  @click="historyTab = 'user'"
                >
                  Lịch sử của bạn
                </li>
              </ul>
              ...
              <div
                class="latest-winner-list"
                :class="{ 'ld-loading': tableLoading }"
              >
                <div class="loading">
                  <div class="loading__ring">
                    <svg
                ...
                <div class="latest-winner-item latest-winner-item--header">
                  <div class="latest-winner-item-col">Thời gian</div>
                  <div class="latest-winner-item-col">Biệt danh</div>
                  <div class="latest-winner-item-col">Streak</div>
                  <div class="latest-winner-item-col">Phần thưởng</div>
                </div>
                <div
                  class="latest-winner-item win"
                  v-for="(user, index) in listUserStreakChallengeRender"
                  :key="index"
                >
                  <template v-if="!isTablet">
                    <div class="latest-winner-item-col">
                      {{ user.created_at }}
                    </div>
                    <div class="latest-winner-item-col">
                      {{ hiddenText(user.nick_name) }}
                    </div>
                    <div class="latest-winner-item-col">
                      <span :class="user.isWin">{{ user.textWinLose }}</span>
                    </div>
                    <div class="latest-winner-item-col">${{ user.prize }}</div>
                  </template>
                  <template v-else>
                    <p :class="['latest-winner-item-streakname', user.isWin]">
                      {{ user.textWinLose }}
                    </p>
                    <div class="latest-winner-item-inner">
                      <div class="latest-winner-item-time">
                        <span class="latest-winner-item-label">Thời gian</span
                        ><span class="latest-winner-item-value">{{
                          user.created_at
                        }}</span>
                      </div>
                      <div class="latest-winner-item-nickname">
                        <span class="latest-winner-item-label">Biệt danh</span
                        ><span class="latest-winner-item-value">{{
                          user.nick_name
                        }}</span>
                      </div>
                      <div class="latest-winner-item-prize">
                        <span class="latest-winner-item-label">Phần thưởng</span
                        ><!----><span class="latest-winner-item-value"
                          >${{ user.prize }}</span
                        >
                      </div>
                ...
                <!-- <div class="latest-winner-item win">
                  <div class="latest-winner-item-col">08/02/2022</div>
                  <div class="latest-winner-item-col">hau***</div>
                  <div class="latest-winner-item-col">
                    <span class="win">Win Streak 9x</span>
                  </div>
                  <div class="latest-winner-item-col">$42.78</div>
                </div>
                <div class="latest-winner-item win">
                  <div class="latest-winner-item-col">08/02/2022</div>
                  <div class="latest-winner-item-col">anh***</div>
                  <div class="latest-winner-item-col">
                    <span class="lose">Win Streak 9x</span>
                  </div>
                  <div class="latest-winner-item-col">$42.72</div>
                </div>
                <div class="latest-winner-item win">
                  <div class="latest-winner-item-col">08/02/2022</div>
                  <div class="latest-winner-item-col">on1***</div>
                  <div class="latest-winner-item-col">
                    <span class="win">Win Streak 9x</span>
                  </div>
                  <div class="latest-winner-item-col">$42.74</div>
                </div>
                <div class="latest-winner-item win">
                  <div class="latest-winner-item-col">08/02/2022</div>
                  <div class="latest-winner-item-col">inh***</div>
                  <div class="latest-winner-item-col">
                    <span class="win">Win Streak 9x</span>
                  </div>
                  <div class="latest-winner-item-col">$42.74</div>
            ...
            <div id="pagination-wrapper">
              <vs-pagination
                v-if="listUserStreakChallengeRender.length"
            ...
            <!-- <div class="d-flex justify-content-center">
              <div id="paging" class="paging text-center mb-4">
                <ul id="page" class="list-unstyled mb-0">
                  <li>
                    <a
                      href="javascript:void(0)"
                      data-page="1"
                      class="active btn-active-paging"
                      >1</a
                    >
                  </li>
                  <li>
          ...
          <div class="container info-guide-inner">
            ...
            <div class="info-guide-body">
              <div class="info-guide-slider">
                <div
                  class="swiper-container swiper-community-jackpot swiper-container-horizontal"
                >
                  <div
                  ...
                  >
                    <div class="swiper-slide swiper-slide-active">
                      <div class="swiper-slide-inner">
                        ...
                        ><span class="swiper-slide-label">Đăng ký</span
                    ...
                    <div class="swiper-slide swiper-slide-next">
                      <div class="swiper-slide-inner">
                        ...
                        ><span class="swiper-slide-label">Giao dịch</span
                        ><span class="swiper-slide-text"
                          >Giao dịch và kiếm thêm lợi nhuận</span
                        >
                      </div>
                    </div>
                    <div class="swiper-slide">
                      <div class="swiper-slide-inner">
                        ...
                        ><span class="swiper-slide-label">Thắng Giải</span
                        ><span class="swiper-slide-text"
                          >Bạn càng giao dịch nhiều thì bạn càng có nhiều cơ hội
                          nhận giải</span
                        >
                      </div>
                    </div>
              ...
              <div class="info-guide-content">
                ...
                <p>
                  Thử Thách Liên Hoàn là một chương trình cho phép các nhà giao
                  dịch đạt được phần thưởng cho cả trận thua và thắng của họ.
                  Thử thách này bắt đầu từ một quỹ cộng đồng bao gồm 0,05% tổng
                  khối lượng giao dịch trên nền tảng của chúng tôi. Quỹ này sẽ
                  được sử dụng để thưởng cho người dùng đạt giải Độc đắc -
                  {{ streakChallenge.precentPrize }}% tổng quỹ cộng đồng cho mỗi
                  người thắng cuộc.
                </p>
                <h5>Các điều khoản và điều kiện</h5>
                <p>
                  Người dùng chỉ có thể giao dịch Tăng hoặc Giảm trong một phiên
                  và phải giao dịch trong các phiên liên tiếp nhau. Mỗi giao
                  dịch trong một phiên phải tối thiểu là ${{
                    streakChallenge.moneyConditional
                  }}. Số chuỗi thắng hoặc số chuỗi thua phải là
                  {{ streakChallenge.consecutive }} lần. Trong trường hợp có
                  nhiều người dùng cùng trúng giải Độc Đắc trong cùng một phiên,
                  giải thưởng sẽ được chia đều cho tất cả người dùng trúng giải
                  trong cùng thời điểm. Người dùng phải hoàn thành xác minh danh
                  tính (KYC) trên hệ thống của chúng tôi để đủ điều kiện tham
                  gia thử thách này. Ngoài ra, hàng ngày sẽ có một giải Mega x5
                  giá trị thưởng được chọn ngẫu nhiên từ những người dùng trúng
                  giải Độc Đắc trong ngày hiện tại. Nếu không có người dùng
                  trúng giải Độc Đắc nào trong ngày hiện tại thì cũng sẽ không
                  có giải Mega. Xin lưu ý rằng phần thưởng sẽ được chuyển vào Ví
                  của tài khoản sau khoảng 48 giờ.
                </p>
                <p>
                  Chúng tôi có quyền thay đổi/ sửa đổi bất kỳ thông tin trong
                  Điều khoản và Điều kiện hoặc bất kỳ chính sách/ hướng dẫn nào
                  của nền tảng của chúng tôi, vào bất cứ thời gian nào và theo
                  quyết định riêng của chúng tôi. Mọi thay đổi/ sửa đổi sẽ có
                  hiệu lực ngay sau khi thông tin điều chỉnh được đăng trên nền
                  tảng của chúng tôi hoặc sẽ thông báo cho bạn về những thay
                  đổi/ sửa đổi đó qua email.
                </p>
                <p>
                  Chương trình Thử Thách Liên Hoàn và các lợi ích của nó được
                  cung cấp theo quyết định riêng của chúng tôi. Chúng tôi có
                  quyền sửa đổi hoặc hủy bỏ giải Độc Đắc cũng như cách mà chúng
                  tôi đánh giá và trao thưởng cho các giao dịch đủ điều kiện của
                  bạn.
                </p>
                <p>
                  Chúng tôi có quyền sửa đổi hoặc chấm dứt quyền nhận giải Độc
                  Đắc của bạn khi phát hiện ra bất kỳ hành vi gian lận và không
                  trung thực nào do bạn thực hiện để nhận thêm giải theo ưu đãi
                  chương trình. Bạn sẽ bị tước quyền tham gia vào chương trình
                  Thử Thách Liên Hoàn hoặc bị cấm sử dụng vĩnh viễn dịch vụ của
                  chúng tôi mà sẽ không có thông báo trước đối với những trường
                  hợp như vậy. Quyết định của chúng tôi sẽ là quyết định cuối
                  cùng và chúng tôi sẽ không tham gia vào bất kỳ cuộc tranh luận
...
export default {
  ...
  created() {
    AuthenticationService.getPrizeUser().then((resp) => {
      if (resp.data.success === 1) {
        this.prize = resp.data.data;
      }
    });

    AuthenticationService.getUserClientStreakChallenge().then((resp) => {
      if (resp.data.success === 1) {
        this.listUserStreakChallenge = resp.data.data;
      }
    });

    AuthenticationService.getStreakClientChallenge().then((resp) => {
      if (resp.data.success === 1) {
        this.streakChallenge = resp.data.data;
      }
    });
  ...
  computed: {
    listUserStreakChallengeRender() {
      let offset = (this.pagination.current - 1) * this.pagination.itemPerPage;
      let limit = offset + this.pagination.itemPerPage;
      let list = this.listUserStreakChallenge;
      // Danh sách của bạn
      if (this.historyTab !== "all") {
        list = list.filter((item) => {
          return (
            item.nick_name == JSON.parse(localStorage.getItem("INFO")).nick_name
          );
        });
      }

      return this.formatStreakChallenge(list).slice(offset, limit);
    },

    streakChallengeRender() {
      return {
        user: this.hiddenText(this.streakChallenge.user),
        userDate: moment(this.streakChallenge.userData).format("DD/MM/YYYY"),
        userMoney: this.formatPrice(this.streakChallenge.userMoney),
      };
    },
  },
  methods: {
    ...
    hiddenText(text, showLength = 3, hiddenLength = 3) {
      try {
        return `${text.slice(0, showLength)}${"*".repeat(hiddenLength)}`;
      } catch (err) {
        return "*".repeat(showLength + hiddenLength);
      }
    },
    ...
    scrollToInfo() {
      document.querySelector("#info-guide").scrollIntoView({
        behavior: "smooth",
      });
    },

    formatStreakChallenge(listUserStreakChallenge) {
      return listUserStreakChallenge.map((user) => {
        return {
          created_at: moment(user.created).format("DD/MM/YYYY"),
          nick_name: this.hiddenText(user.nick_name),
          prize: this.formatPrice(user.prize),
          isWin: user.isWin ? "win" : "lose",
          textWinLose: user.isWin ? "Win Streak 9x" : "Lose Streak 9x",
        };
      });
    },
  },
  ...
  watch: {
    listUserStreakChallenge() {
      this.pagination.total = Math.ceil(
        this.listUserStreakChallenge.length / this.pagination.itemPerPage
      );
    },
    ...
    historyTab(val) {
      ...
      if (val === "all") {
        ...
        this.pagination.total = Math.ceil(
          this.listUserStreakChallengeRender.length /
...
.community-jackpot {
  ...
  padding-top: 95px;
  background: #090b0d
    url("~@/assets/images/pages/streak-challenge/bg-1.bb570abf.png") top
    no-repeat;
  ...
  &:before {
    ...
    width: 374px;
    height: 356px;
    background: url("~@/assets/images/pages/streak-challenge/img-1.71d8078d.png");
  ...
  .prize-pool {
    ...
    border-radius: 25px;
    background: rgba(41, 12, 126, 0.44);
    display: -webkit-box;
    display: -ms-flexbox;
    display: flex;
    ...
    &:before {
      ...
      height: 108px;
      display: block;
      background: url("~@/assets/images/pages/streak-challenge/box-2.cca970d1.png")
        0 0 no-repeat;
    ...
    .prize-pool-label {
      ...
      &:after {
        ...
        width: 100%;
        height: 75px;
        background: url("~@/assets/images/pages/streak-challenge/fire_2.0bb9224e.png")
          0 0 no-repeat;
    ...
    .prize-pool-mega-fund {
      position: absolute;
      width: 370px;
      height: 77px;
      background: url("~@/assets/images/pages/streak-challenge/mega-fund.9f6d81da.png")
        0 0 no-repeat;
      background-size: cover !important;
      left: 50%;
      -webkit-transform: translateX(-50%);
    ...
    &:after {
      ...
      height: 148px;
      display: block;
      background: url("~@/assets/images/pages/streak-challenge/box-3.892cbd71.png")
        0 0 no-repeat;
      background-size: cover !important;
      position: absolute;
      top: 50%;
  ...
  .bg {
    background: url("~@/assets/images/pages/streak-challenge/bg-2.b876c51a.png")
      top no-repeat;
    background-size: 100% auto;
    position: relative;
    z-index: 2;
      ...
      .container {
        ...
        .latest-winner-mega {
          ...
          &:before {
            ...
            width: 99px;
            height: 99px;
            background: url("~@/assets/images/pages/streak-challenge/box-8.b7415b73.png")
              0 0 no-repeat;
            background-size: cover !important;
            position: absolute;
            top: 0;
          ...
          .latest-winner-mega-body {
            .latest-winner-mega-name {
              font-size: 24px;
              font-weight: 700;
              color: #f7a62f;
              text-transform: uppercase;
          ...
          .latest-winner-mega-prize {
            width: 298px;
            height: 66px;
            padding-top: 15px;
            background: url("~@/assets/images/pages/streak-challenge/mega-fund-2.bf69f480.png")
              0 0 no-repeat;
            background-size: cover;
            font-size: 19px;
            font-weight: 700;
          ...
          &:after {
            ...
            width: 93px;
            height: 93px;
            background: url("~@/assets/images/pages/streak-challenge/box-9.a5494ca0.png")
              0 0 no-repeat;
            background-size: cover !important;
            position: absolute;
            top: 50%;
        ...
        .latest-winner-table {
          ...
          .latest-winner-list {
            ...
            .latest-winner-item {
              ...
              .latest-winner-item-inner {
                display: flex;

                .latest-winner-item-label {
                  font-size: 12px;
                  color: rgba(131, 143, 174, 0.7);
                }

                .latest-winner-item-value {
                  font-size: 14px;
                }
                .latest-winner-item-time,
                .latest-winner-item-nickname,
                .latest-winner-item-prize {
                  display: flex;
              ...
              .latest-winner-item-streakname {
                display: block;
                font-weight: 700;
                font-size: 16px;
                margin-bottom: 10px;
              }
              &:nth-child(3) .latest-winner-item-col {
                border-top: none;
              }

              .latest-winner-item-col {
                display: table-cell;
                padding: 16px 20px;
                border-top: 1px solid rgba(170, 176, 187, 0.27);
    ...
    .info-guide {
      color: #fff;
      padding-bottom: 30px;
      background: url("~@/assets/images/pages/streak-challenge/bg-3.805f565a.png")
        top no-repeat;
      background-size: cover;
      position: relative;
      ...
      &:before {
        ...
        width: 186px;
        height: 186px;
        background: url("~@/assets/images/pages/streak-challenge/streak-icon-2.accaafab.png");
        background-size: cover;
        position: absolute;
        top: -90px;
        left: -40px;
      ...
      .info-guide-slider {
        ...
        .swiper-community-jackpot .swiper-wrapper {
          -webkit-box-align: stretch;
          -ms-flex-align: stretch;
          align-items: stretch;
      ...
      &:after {
        ...
        width: 318px;
        height: 318px;
        background: url("~@/assets/images/pages/streak-challenge/streak-icon-3.7d63b463.png");
        background-size: cover;
        position: absolute;
        top: 70px;
        right: -70px;
