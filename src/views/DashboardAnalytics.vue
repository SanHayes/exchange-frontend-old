      ...
      <div class="vx-col w-full md:w-1/2 lg:w-1/2 xl:w-1/2 mb-base">
        <vx-card title="Số dư người dùng còn lại">
          <div class="vx-row">
            <div class="vx-col w-1/2 mb-3">
              <p>
                Tổng số dư Paypal:<br />
                <span class="font-bold"
                  >${{ formatPrice(dataGet.tsTNPAYPALN, 2) }}</span
                >
              </p>
            </div>
            <div class="vx-col w-1/2 mb-3">
              <p>
                Tổng số dư BTC:<br />
                <span class="font-bold"
                  >${{ formatPrice(dataGet.tsTNBTCN, 6) }}</span
                >
              </p>
            </div>
            <div class="vx-col w-1/2 mb-3">
              <p>
                Tổng số dư ETH:<br />
                <span class="font-bold"
                  >${{ formatPrice(dataGet.tsTNETHN, 4) }}</span
                >
              </p>
            </div>
            <div class="vx-col w-1/2 mb-3">
            ...
            <div class="vx-col w-1/2 mb-3">
              <p>
                Tổng số dư VN:<br />
                <span class="font-bold"
                  >${{ formatPrice(dataGet.tsTNVNN, 0) }}</span
                >
              </p>
            </div>
          </div>
