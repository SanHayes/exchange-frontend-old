                    ...
                    <div class="boxAddress">
                        ...
                        <div v-if="isVND" :class="isMobile ? 'scrollMobile' : ''">
                           <div class="deposit_widthdraw_box" v-if="activeNRT">
                                <NapTienVue v-if="!isNextNapTien" @submitBank="nextNapTien" />
                                <div v-else class="text-center address">
                                    <div class="p-3">
...
import NapTienVue from '@/components/Nap-Tien-VND.vue';
...
export default {
    ...
    methods: {
        ...
        getBankInfo() {
            AuthenticationService.getBankInfo()
            .then((res) => {
                let d = res.data
