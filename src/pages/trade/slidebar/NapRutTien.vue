                ...
                <div class="listUnits shadow">
                  ...
                  >
                    ...
                    <div class="info">
                      <div class="amount w-full">
                        <span class="number"
                          >{{ activeNRT ? "Nạp" : "Rút" }} tiền VNĐ</span
                        >
                      </div>
                    </div>
                  </div>
          ...
          <div class="boxAddress">
                  ...
                  >
                    ...
                    >
                      ...
                      <span class="transfer-network-item-fee"
                        >Phí: {{ getSetSys.feeRutPaypalNoiBo }} USD</span
                      >
                    </li>
                    <li
                      class="transfer-network-item"
                    ...
                    >
                      ...
                      <span class="transfer-network-item-fee"
                        >Phí: {{ getSetSys.feeRutPaypalAcc }} USD</span
                      >
                    </li>
                  </ul>
                </div>
                <div class="deposit_widthdraw_box">
                  <div class="form-group relative mt-4">
                    ...
                    <input
                      ...
                      v-model="amount"
                      decimal="true"
                      :placeholder="`Số tiền tối thiểu: ${getSetSys.minDepositPaypal} USDT`"
                      class="form-control"
                    />
                    <input
                      v-if="!activeNRT"
                      ...
                      v-model="amount"
                      decimal="true"
                      :placeholder="`Số tiền tối thiểu: ${getSetSys.minWithdrawalPaypal} USDT`"
                      class="form-control"
                    />
                    <button
                  ...
                  <div class="text-center address">
                    <div class="text-center p-4" v-if="isNap">
                      ...
                      <p class="p-3">
                        Có 1 cửa sổ Popup sẽ được bật lên, vui lòng thánh toán
                        để hoàn thành.
                      </p>
                      <i
                        >* Lưu ý: Nếu bạn không thấy của sổ Popup bật lên xin
                        vui lòng vào trình duyệt Cài đặt -> bỏ chặn Cửa sổ bật
                        lên</i
                      >
                    </div>
            ...
            <div v-if="isVND" :class="isMobile ? 'scrollMobile' : ''">
              <div class="deposit_widthdraw_box" v-if="activeNRT">
                ...
                <div class="text-center address">
                  ...
                  <div>
                    <b
                      >Sau khi chuyển khoản bạn hãy ấn nút nạp tiền ở bên
                      dưới.</b
                    >
                  </div>
                  <i
            ...
            <div v-else>
              <div class="transfer-network">
                ...
                >
                  <span class="font-bold">Chú ý:</span> Để đảm bảo an toàn cho
                  tài sản của bạn, xin hãy xác nhận lần nữa blockchain bạn cần
                  dùng là BSC.
                </p>
                <p
                  class="transfer-network-warn"
              ...
              <div class="depos" :class="{ block: activeNRT }">
                <h4 class="text-center">
                  Địa chỉ nạp <span>USDT</span> của bạn
                </h4>
                  ...
                  <div class="md:w-full">
                    ...
                    <div class="md:w-full text-center">
                      <div class="address">
                        ...
                        >
                        <vs-alert>
                          Sau khi nạp vui lòng giữ nguyên cửa sổ này. Nếu chờ 5p
                          chưa thấy số dư tài khoản thì
                          <span class="link" @click="scanWallet"
                            >click để admin check tài khoản cho bạn</span
                          >
                        </vs-alert>
                        <br />
...
export default {
  ...
  methods: {
    ...
    scanWallet() {
      if (this.disableCheckWallet) {
        return this.$vs.notify({
          text: `Vui lòng đợi 30s trước khi gửi yêu cầu tiếp theo!`,
          iconPack: "feather",
          icon: "icon-check",
          position: "top-right",
          color: "danger",
      ...
      return this.$vs.notify({
        text: `Đã gửi yêu cầu tới admin. Hãy chờ đợi!`,
        iconPack: "feather",
        icon: "icon-check",
        position: "top-right",
        color: "success",
  ...
  created() {
    ...
    this.getBankInfo();
    this.selectTypePay(this.moneyType);
  },
};
</script>
