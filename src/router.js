    ...
    // =============================================================================
        ...
        // =============================================================================
...

                {
                    path: '/staking-rate',
                    name: 'staking-rate',
                    component: () => import('./layouts/game/Interest.vue'),
                    meta: {
                        breadcrumb: [
                            { title: 'Trang chủ', url: '/' },
                            { title: 'Lãi suất qua đêm', active: true },
                        ],
                        pageTitle: 'Lãi suất qua đêm',
                        rule: 'editor'
                    },
                },
                ...
                // Streak Challenge
                // {
                //     path: '/tool/streak-challenge',
                //     name: 'tool/streak-challenge',
                //     component: () => import('./layouts/game/streakChallenge.vue'),
                //     meta: {
                //         breadcrumb: [
                //             { title: 'Trang chủ', url: '/' },
                //             { title: 'Streak Challenge', active: true },
                //         ],
                //         pageTitle: 'Tạo Streak Challenge',
                //         rule: 'editor'
                //     },
                // },
